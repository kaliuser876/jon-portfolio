...
export default function SkillIcon(props){
    return (
         <div className="relative group w-24 sm:w-28 flex flex-col items-center rounded-xl overflow-hidden shadow-md transition-transform hover:scale-105 duration-300 bg-gray-200 dark:bg-gray-800">
